...
using Storemey.Tests.Sessions;
using NSubstitute;
using Shouldly;
using Xunit;

namespace Storemey.Tests.Events
{
    public class EventAppService_Tests : StoremeyTestBase
    {
        ...
        private static Event GetTestEvent(StoremeyDbContext context)
        {
